...
public class StringRefl
{
	static
	{
		//line 204 "/usr/share/haxe/std/java/internal/StringExt.hx"
	...
	public static java.lang.Object handleGetField(java.lang.String str, java.lang.String f, boolean throwErrors)
	{
		//line 209 "/usr/share/haxe/std/java/internal/StringExt.hx"
		{
				...
				switch (__temp_hash3)
				{
					case -1106363674:
					{
						...
						if (__temp_svar1.equals("length")) 
						{
							...
							//line 211 "/usr/share/haxe/std/java/internal/StringExt.hx"
							return str.length();
						}
			...
			if (__temp_executeDef2) 
			{
				...
				if (throwErrors) 
				{
					//line 216 "/usr/share/haxe/std/java/internal/StringExt.hx"
					throw ((java.lang.RuntimeException) (haxe.Exception.thrown(( ( "Field not found: \'" + f ) + "\' in String" ))) );
				}
				else
				{
					//line 218 "/usr/share/haxe/std/java/internal/StringExt.hx"
					return null;
				}
	...
	{
		//line 223 "/usr/share/haxe/std/java/internal/StringExt.hx"
		java.lang.Object[] _args = null;
		//line 224 "/usr/share/haxe/std/java/internal/StringExt.hx"
		if (( args == null )) 
		{
			//line 225 "/usr/share/haxe/std/java/internal/StringExt.hx"
			_args = ((java.lang.String[]) (new java.lang.String[]{haxe.lang.Runtime.toString(str)}) );
		}
		else
		{
			//line 227 "/usr/share/haxe/std/java/internal/StringExt.hx"
